# stable-replay-reason-ownership Specification

## Purpose

Keep replay pre-commit reason ownership stable across unrelated source edits without changing runtime classification, exit status, or receipt behavior.
