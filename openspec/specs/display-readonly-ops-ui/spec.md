# display-readonly-ops-ui Specification
...
- **THEN** the backend accepts or exposes enough contract fields to bind `source`, `cycle_time`, `run_id`, and `model_id` together
