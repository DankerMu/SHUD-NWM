# explicit-cycle-query-binding Specification

## Purpose
Define how the explicit-cycle readiness recorder validates and preserves native psycopg parameter bindings from captured forecast SQL through live `EXPLAIN` and deterministic query identity while retaining G7 safety controls.
