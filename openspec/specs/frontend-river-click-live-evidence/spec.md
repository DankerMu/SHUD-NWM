# frontend-river-click-live-evidence Specification

## Purpose

Define the gated, no-mock browser oracle and private current-run evidence contract used to prove that one real rendered river click loads complete current GFS and IFS forecast series within the live-display P95 threshold without changing ordinary user behavior.
