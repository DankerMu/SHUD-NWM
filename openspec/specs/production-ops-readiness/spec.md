...
## Purpose
Operator-facing readiness of the production deployment: the single-command display restart, readiness checks and runbook contracts that let an operator restart, verify and recover the node-27 services without ad-hoc host knowledge.
