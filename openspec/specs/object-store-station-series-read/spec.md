...
## Purpose
Define the direct object-store station-series read path that serves SHUD forcing CSV values from retained disk artifacts while preserving the existing public StationSeriesResponse contract.
