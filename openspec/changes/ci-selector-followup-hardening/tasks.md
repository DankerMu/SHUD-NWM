...
- [x] R2.1 Predicate completed to BOTH pytest default `python_files`
...
- [x] R2.2 Pytest-anchor test (the invariant closure): build a tmp
...
- [x] R2.3 `*_test.py` sibling pin next to the nested-suite pin
