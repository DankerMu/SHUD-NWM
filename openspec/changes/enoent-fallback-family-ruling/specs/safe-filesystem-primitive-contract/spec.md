...
- **WHEN** its body carries no comment of the form `ADR 0009 clause N` or `ADR 0009 loop-filtered`
- **THEN** the family guard reports it, so that deleting the marker from any one member turns the guard red
