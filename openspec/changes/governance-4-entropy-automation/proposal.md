...
- Later Governance-4 slices add a governance workflow that initially uploads or
  prints reports without failing PRs.
- Later Governance-4 slices define escalation rules for converting selected
  checks into hard gates after the baseline stabilizes.
...
- Docs: `docs/governance/entropy-budget.md`,
  `docs/governance/entropy-report.example.md` in #372.
- CI: `.github/workflows/governance.yml` or additions to existing CI in #373.
