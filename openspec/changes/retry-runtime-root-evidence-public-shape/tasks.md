...
- [x] node-27 receipt (host ghdc, HEAD 9b6221ee: five suites 2850 passed on the real DB + `tests/test_api*.py` 140 passed; cycle proof `False False`; command lines in `.workplans/pr-1961/node27-receipt-9b6221ee.txt`; the 7364748a run's ssh session hung after the remote pytest finished and was discarded, re-run detached at 9b6221ee; final-head receipt: see the PR body)
...
- [x] CI green on every pushed head, recorded in the round ledger (7364748a run 33701580924: Unit Tests success, 5262 passed; 9b6221ee run 33705228610: Unit Tests success, 5265 passed; final head: see the PR body)
