...
- [ ] 1.1 `scripts/node27_autopipeline.py`：phase 3.5 stats guard——
...
- [ ] 1.2 `scripts/node27_timeseries_compression.py`：全部压缩完成后、receipt
...
- [ ] E3 `openspec validate frontier-chunk-stats-analyze-guard --strict --no-interactive` PASS
