...
SHALL reject a minimum age below the live DB retention window, so the
...
Archive minimum age SHALL reuse the shared live-retention-window safety
invariant and SHALL reject explicit zero or below-live-window inputs rather
than falling back.
