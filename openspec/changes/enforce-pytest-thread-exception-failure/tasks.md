...
- [ ] 4.4 Node-27 `pytest -q -m integration` passes under exact warning escalation with real DB; node-22 is not applicable because Slurm/SHUD scheduling is unchanged.
