...
- **WHEN** every model keeping the oldest gap a gap is breaker-engaged, and one of them has an operator re-entry confirmation whose recorded token and pin equal the live stale token and occurrence count
