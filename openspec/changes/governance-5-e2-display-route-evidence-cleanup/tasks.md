...
- [ ] 4.1 On node-27, migrate old URL handoff generation from old paths to `/` query form where production single-map code still generates `/forecast`, `/segments/...`, `/basins/...`, or `/flood-alerts` URLs.
