...
- [x] 4.4 On node-27, delete `ForecastPage`, `FloodAlertPage`, `SegmentDetailPage`, `MeteorologyPage`, and `LegacyPagesHarness` only after imports and tests are clean.
- [x] 4.5 Mark all old-page implementation issues as node-27/display_readonly execution items; do not implement frontend source changes from node-22.
