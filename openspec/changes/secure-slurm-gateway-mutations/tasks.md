...
- [x] 4.8 `uv run pytest -q tests/test_auth_policy_matrix.py tests/test_slurm_gateway_auth.py tests/test_slurm_gateway_app.py tests/test_gateway.py tests/test_slurm_route_contract.py tests/test_orchestration_chain.py tests/test_openapi_31_contract.py tests/test_openapi_drift.py tests/test_runtime_mode.py tests/test_role_boundary_static.py` passes on the final head.
