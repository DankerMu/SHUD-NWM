...
CASES = [
    dict(label="shj_nj/latest", pin=SHJ, store="narrow",
         cycle="newest", scenario="GFS", latest=True),
    dict(label="small_tailanhe/latest", pin=SMALL, store="narrow",
         cycle="newest", scenario="GFS", latest=True),
]
