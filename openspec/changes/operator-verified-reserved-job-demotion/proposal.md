...
- Replace the runbook's unsupported hand-edit dead end with the guarded command and node-22 verification procedure.
...
- Operations: `docs/runbooks/failed-basin-retry.md` and a node-22 live receipt.
- No database migration, PostgreSQL reclaim change, Slurm configuration change, HTTP retry expansion, or automatic comment-less absence heuristic.
