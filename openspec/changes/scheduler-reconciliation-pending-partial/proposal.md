...
- Preserve an already-confirmed dispatch across any same-stage retry history, including empty-ID intermediate failures before a nested or outer pending result; a bare pending token still does not imply submission.
