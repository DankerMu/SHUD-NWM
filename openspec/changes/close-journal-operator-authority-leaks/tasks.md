...
- [ ] 3.4 After push, run the same focused db-free pytest on node-27; node-22 runtime validation is not required because no sbatch, Slurm gateway, SHUD runtime, or scheduling behavior changes.
...
- [ ] 4.3 Complete the final acceptance-criterion, selected-risk-pack, oracle-integrity, and no-deviation audit for both #1805 and #1804.
