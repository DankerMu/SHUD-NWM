...
- **WHEN** `chain.COMPLETED_HYDRO_STATUSES`, `chain_repository.COMPLETED_HYDRO_STATUSES` and `chain_forecast_trigger._completed_hydro_statuses()` are compared by identity with `scheduler_state_types.DURABLE_HYDRO_SUCCESS_STATUSES`
