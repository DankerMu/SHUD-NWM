...
- [x] node-27 receipt at the final head (same suites, real DB; command lines + counts in the PR body) — recorded: 66247c1a on node-27, ten suites 3505 passed / 1 skipped (1138s) + `tests/test_select_ci_tests.py` 460 passed (`/home/nwm/tmp/receipt-1995-66247c1a.log`); the final head trails it only across a docs-only fixture commit
