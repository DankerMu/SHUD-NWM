...
```text
NWM/
├── 全国水文模拟系统_建设汇报稿.md          ← 面向甲方的系统建设汇报文档
├── 全国水文模拟系统_气象数据梳理与决策跟踪_v0.1.md  ← 气象数据源全面梳理与接入方案
├── 设计图/                                ← 全部设计图（架构图 + 数据流转图 + 数据关系图 + 前端效果图 1-8）
│   ├── 系统架构图.png
│   ├── 业务运转数据流转图.png
│   ├── 数据关系图.png
│   └── 前端效果图1.png ~ 前端效果图8.png
└── 全国水文模拟系统_设计与开发Spec_v0.1/    ← 本目录，设计与开发规格文档包
```

### Spec 目录

```text
全国水文模拟系统_设计与开发Spec_v0.1/
├── README.md                              ← 本文件，入口与导航
│
│  ── 核心设计文档 ──
...
2. **`../全国水文模拟系统_建设汇报稿.md`** — 系统全貌概览（含全部设计图），适合首次接触本项目
...
6. **`../全国水文模拟系统_气象数据梳理与决策跟踪_v0.1.md`** — 9 类气象数据源详细卡片、SHUD forcing 需求、接入优先级与开发顺序
...
10. **`06_frontend_gis_design.md`** — 全部 8 个页面的功能规格（搭配 `../设计图/前端效果图*.png` 对照阅读）
...
| 设计图 | 文件 | 对应文档 | 说明 |
|---|---|---|---|
| 系统架构图 | `../设计图/系统架构图.png` | `01` 六层架构 | 六层物理视角的全栈技术架构 |
| 业务运转数据流转图 | `../设计图/业务运转数据流转图.png` | `01` 端到端流程 | 六大环节数据流+控制流+状态回传 |
| 数据关系图 | `../设计图/数据关系图.png` | `03` 数据库设计 | 五大实体域的逻辑关联 |
| 前端效果图 1 | `../设计图/前端效果图1.png` | `06` §2 全国总览 | 默认首页、河网、流域弹窗 |
| 前端效果图 2 | `../设计图/前端效果图2.png` | `06` §7.2 流域详情 | 河段交互、详情面板 |
| 前端效果图 3 | `../设计图/前端效果图3.png` | `06` §7.6 预报曲线 | 全屏三栏、多源对比、频率阈值 |
| 前端效果图 4 | `../设计图/前端效果图4.png` | `06` §13 洪水预警 | 预警总览、TOP 排名 |
| 前端效果图 5 | `../设计图/前端效果图5.png` | `06` §8B 气象空间 | 栅格瓦片、区域统计 |
| 前端效果图 6 | `../设计图/前端效果图6.png` | `06` §8 气象代站 | 站点列表、forcing 时序 |
| 前端效果图 7 | `../设计图/前端效果图7.png` | `06` §14 资产管理 | 模型版本、关系图 |
| 前端效果图 8 | `../设计图/前端效果图8.png` | `06` §15 产品监控 | 流水线状态、趋势图 |
