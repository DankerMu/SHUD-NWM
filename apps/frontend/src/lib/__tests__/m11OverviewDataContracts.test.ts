...
describe('M11 overview data contracts', () => {
  ...
  it('normalizes selected segment detail with forecast provenance, trend points, and lineage status', () => {
    ...
    expect(detail).toMatchObject({
      ...
      handoffUrl:
        '/?source=compare&cycle=2026-05-18T00%3A00%3A00.000Z&validTime=2026-05-18T06%3A00%3A00.000Z&basinVersionId=yangtze_v2026_01&riverNetworkVersionId=yangtze_rivnet_v12&segmentId=yangtze_rivnet_v12_riv_000123',
