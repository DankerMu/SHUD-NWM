...
// So a missing env here is tolerated into a placeholder; the owner performs
...
export default defineConfig({
  ...
  projects: [
    {
      name: 'live-river-click-chromium',
