...
- #150 E2E closure lane 已覆盖 redacted staging preflight、#147/#148/#149 dependency evidence consumed/skipped/missing/blocked semantics、完整 stage manifest、derived `model_id/basin_version_id/segment_id/source/cycle_time/job_id/layer_id`、API contract evidence、frontend smoke lineage evidence、missing/malformed/non-finite/missing-required/count/time-axis SHUD output QC blockers、downstream publication blocking、secret redaction、run-scoped idempotency/path safety。
