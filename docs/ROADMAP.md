...
| ✅ | 前端预报曲线展示 | Danker | 点击河段查看过去 3 天（分析）+ 未来 7 天（预报）拼接曲线 |

**怎么算完成**
- 1 个流域的 GFS 预报结果成功入库
- 预报使用了分析运行的初始状态（热启动）
- 前端点击河段能看到完整的 10 天曲线（过去 3 天 + 未来 7 天）
