...
uv run pytest -q tests/test_runtime_mode.py tests/test_api.py tests/test_monitoring_api.py
uv run ruff check apps/api/main.py apps/api/openapi_patching.py apps/api/route_registry.py apps/api/startup_wiring.py tests/test_api.py tests/test_openapi_drift.py tests/test_runtime_mode.py tests/test_role_boundary_static.py tests/test_monitoring_api.py
