...
Governance-8 owner-module updates as follow-up extractions land, Governance-8
issue #767 inventory synchronization evidence, and
`facade-shrink-scheduler-chain` scheduler/chain shrink evidence. This inventory
...
The original inventory evidence is the 2026-06-26 snapshot. Only the
scheduler-config owner paths and line counts were refreshed on 2026-08-28
for issue #1872; all unrelated rows retain their recorded snapshot values.
The command below replays the current evidence:

```bash
wc -l services/orchestrator/scheduler.py services/orchestrator/scheduler_adapters.py services/orchestrator/scheduler_state_compat.py services/orchestrator/scheduler_gateway.py services/orchestrator/scheduler_runtime_roots.py services/orchestrator/scheduler_types.py services/orchestrator/scheduler_config/__init__.py services/orchestrator/scheduler_config/config.py services/orchestrator/scheduler_config/db_free.py services/orchestrator/scheduler_config/path_modes.py services/orchestrator/scheduler_models.py services/orchestrator/scheduler_candidate_quality.py services/orchestrator/scheduler_preflight.py services/orchestrator/scheduler_runtime.py services/orchestrator/scheduler_cancellation.py services/orchestrator/scheduler_candidate_manifest.py services/orchestrator/scheduler_candidate_execution_evidence.py services/orchestrator/scheduler_evidence.py services/orchestrator/scheduler_evidence_payload.py services/orchestrator/scheduler_evidence_proofs.py services/orchestrator/chain.py services/orchestrator/chain_manifests.py services/orchestrator/chain_manifest_contracts.py services/orchestrator/chain_config.py services/orchestrator/chain_analysis.py services/orchestrator/chain_analysis_orchestrator.py services/orchestrator/chain_forecast_control.py services/orchestrator/chain_forecast_cycle.py services/orchestrator/chain_forecast_trigger.py services/orchestrator/chain_forecast_execution.py services/orchestrator/chain_forecast_state.py services/orchestrator/chain_forecast_submission.py services/orchestrator/chain_forecast_templates.py services/orchestrator/chain_workspace.py services/orchestrator/chain_slurm_client.py services/orchestrator/chain_repository.py services/orchestrator/chain_repository_state.py services/orchestrator/chain_source_cycle.py services/orchestrator/chain_runtime_utils.py services/production_closure/two_node_e2e_evidence.py services/production_closure/readiness_validation.py apps/api/main.py apps/frontend/src/components/map/M11MapLibreSurface.tsx
uv run python scripts/governance/audit_repo_entropy.py --format json >/tmp/nwm-entropy-668.json
```

The line-count evidence is the original 2026-06-26 snapshot plus the local
2026-08-28 scheduler-config refresh:

| Path | Current lines |
|---|---:|
| `services/orchestrator/scheduler.py` | 2184 |
| `services/orchestrator/scheduler_adapters.py` | 247 |
| `services/orchestrator/scheduler_state_compat.py` | 262 |
| `services/orchestrator/scheduler_gateway.py` | 212 |
| `services/orchestrator/scheduler_runtime_roots.py` | 468 |
| `services/orchestrator/scheduler_types.py` | 136 |
| `services/orchestrator/scheduler_config/__init__.py` | 204 |
| `services/orchestrator/scheduler_config/config.py` | 856 |
| `services/orchestrator/scheduler_config/db_free.py` | 604 |
| `services/orchestrator/scheduler_config/path_modes.py` | 204 |
| `services/orchestrator/scheduler_models.py` | 311 |
| `services/orchestrator/scheduler_candidate_quality.py` | 410 |
| `services/orchestrator/scheduler_preflight.py` | 734 |
| `services/orchestrator/scheduler_runtime.py` | 926 |
| `services/orchestrator/scheduler_cancellation.py` | 121 |
| `services/orchestrator/scheduler_candidate_manifest.py` | 325 |
| `services/orchestrator/scheduler_candidate_execution_evidence.py` | 961 |
| `services/orchestrator/scheduler_evidence.py` | 871 |
| `services/orchestrator/scheduler_evidence_payload.py` | 577 |
| `services/orchestrator/scheduler_evidence_proofs.py` | 581 |
| `services/orchestrator/chain.py` | 3415 |
| `services/orchestrator/chain_manifests.py` | 874 |
| `services/orchestrator/chain_manifest_contracts.py` | 524 |
| `services/orchestrator/chain_config.py` | 123 |
| `services/orchestrator/chain_analysis.py` | 166 |
| `services/orchestrator/chain_analysis_orchestrator.py` | 179 |
| `services/orchestrator/chain_forecast_control.py` | 310 |
| `services/orchestrator/chain_forecast_cycle.py` | 402 |
| `services/orchestrator/chain_forecast_trigger.py` | 388 |
| `services/orchestrator/chain_forecast_execution.py` | 786 |
| `services/orchestrator/chain_forecast_state.py` | 546 |
| `services/orchestrator/chain_forecast_submission.py` | 166 |
| `services/orchestrator/chain_forecast_templates.py` | 97 |
| `services/orchestrator/chain_workspace.py` | 319 |
| `services/orchestrator/chain_slurm_client.py` | 124 |
| `services/orchestrator/chain_repository.py` | 993 |
| `services/orchestrator/chain_repository_state.py` | 333 |
| `services/orchestrator/chain_source_cycle.py` | 753 |
| `services/orchestrator/chain_runtime_utils.py` | 866 |
| `services/production_closure/two_node_e2e_evidence.py` | 4526 |
| `services/production_closure/readiness_validation.py` | 1193 |
...
|---|---:|---|---|---|---|---|---|
| `services/orchestrator/scheduler.py` | 2184 | P1 | `compute_control` scheduler/orchestrator facade; state compat installer owner is `services/orchestrator/scheduler_state_compat.py`; adapter/provider owner is `services/orchestrator/scheduler_adapters.py`; gateway/preflight orchestration owner is `services/orchestrator/scheduler_gateway.py`; runtime root/config helper owner is `services/orchestrator/scheduler_runtime_roots.py`; type owner is `services/orchestrator/scheduler_types.py`; config owner is the `services/orchestrator/scheduler_config` package (`config.py` + `path_modes.py` + `db_free.py` + compatibility barrel `__init__.py`); active model discovery/coercion owner is `services/orchestrator/scheduler_models.py`; candidate quality/output owner is `services/orchestrator/scheduler_candidate_quality.py`; Slurm/preflight helper owner is `services/orchestrator/scheduler_preflight.py`; scheduler pass runtime owner is `services/orchestrator/scheduler_runtime.py`; cancel-requested active Slurm owner is `services/orchestrator/scheduler_cancellation.py`; candidate manifest owner is `services/orchestrator/scheduler_candidate_manifest.py`; candidate execution/model-run evidence owner is `services/orchestrator/scheduler_candidate_execution_evidence.py`; scheduler evidence payload-size owner is `services/orchestrator/scheduler_evidence_payload.py`; scheduler evidence proof owner is `services/orchestrator/scheduler_evidence_proofs.py` | Compatibility facade retained while scheduler state monkeypatch installer moved to `scheduler_state_compat.py`, scheduler adapter/provider protocols and env factories moved to `scheduler_adapters.py`, Slurm preflight/gateway orchestration moved to `scheduler_gateway.py`, scheduler runtime-root preflight and config path/env helper bodies moved to `scheduler_runtime_roots.py`, scheduler result/model/candidate dataclasses moved to `scheduler_types.py`, `ProductionSchedulerConfig` moved to the `scheduler_config` package (`config.py`, `path_modes.py`, `db_free.py`, barrel `__init__.py`), active model discovery/coercion helpers and the scheduler model-discovery method body moved to `scheduler_models.py`, candidate quality/output helpers moved to `scheduler_candidate_quality.py`, Slurm/preflight helper bodies moved to `scheduler_preflight.py`, scheduler runtime/cancellation method bodies moved to `scheduler_runtime.py` / `scheduler_cancellation.py`, candidate manifest helpers moved to `scheduler_candidate_manifest.py`, candidate execution/model-run evidence helpers moved to `scheduler_candidate_execution_evidence.py`, and scheduler evidence payload fitting/proof helpers moved behind `scheduler_evidence.py` to `scheduler_evidence_payload.py` / `scheduler_evidence_proofs.py` under `facade-shrink-scheduler-chain`. Keep state, adapter/provider, and gateway facade forwarders monkeypatch-compatible because legacy tests patch state helpers, `_default_adapters`, `_active_repository_from_env`, `_canonical_readiness_provider_from_env`, `_forcing_producer_from_env`, `_orchestrator_repository_from_env`, `_default_gateway_probe`, and `_slurm_gateway_backend` through `scheduler.py`; keep `uuid4`, `redact_payload`, and `MAX_EVIDENCE_BYTES` facade compatibility for scheduler-pass and evidence tests. | #669, #671, `facade-shrink-scheduler-chain` | Retain legacy scheduler private names until callers migrate to owner modules or stable public scheduler APIs. New state compat, adapter/provider, gateway, runtime-root, config helper, type, config, model discovery, candidate quality/output, preflight, runtime, cancellation, candidate manifest, candidate execution evidence, scheduler evidence payload, or scheduler evidence proof helper exposure must update `docs/governance/SCHEDULER_COMPATIBILITY_INVENTORY.md` with owner, retention, removal condition, and focused verification. | `wc -l`; `uv run pytest -q tests/test_production_scheduler.py -k "candidate_state_decision_scheduler_monkeypatch or owner_module_matches_scheduler_facade or bounded_evidence_owner_module_matches_scheduler_facade"`; `uv run pytest -q tests/test_entropy_audit_script.py -k "compatibility_facade or structural_file_budget or scheduler"`; `uv run ruff check services/orchestrator/scheduler.py services/orchestrator/scheduler_state_compat.py services/orchestrator/scheduler_evidence.py services/orchestrator/scheduler_evidence_payload.py services/orchestrator/scheduler_evidence_proofs.py`; `openspec validate facade-shrink-scheduler-chain --strict --no-interactive`; `git diff --check`. |
| `services/orchestrator/chain.py` | 3415 | P1 | `compute_control` orchestration chain facade and aggregation surface; manifest facade owner is `services/orchestrator/chain_manifests.py` with manifest contract/quality helper owner `services/orchestrator/chain_manifest_contracts.py`; config/error owner is `services/orchestrator/chain_config.py`; source-cycle owner is `services/orchestrator/chain_source_cycle.py`; runtime owner is `services/orchestrator/chain_runtime_utils.py`; analysis class owner is `services/orchestrator/chain_analysis_orchestrator.py`; analysis method owner is `services/orchestrator/chain_analysis.py`; forecast owners are `services/orchestrator/chain_forecast_control.py`, `services/orchestrator/chain_forecast_cycle.py`, `services/orchestrator/chain_forecast_trigger.py`, `services/orchestrator/chain_forecast_execution.py`, `services/orchestrator/chain_forecast_state.py`, `services/orchestrator/chain_forecast_submission.py`, and `services/orchestrator/chain_forecast_templates.py`; workspace/log owner is `services/orchestrator/chain_workspace.py`; HTTP Slurm client owner is `services/orchestrator/chain_slurm_client.py`; repository body owner is `services/orchestrator/chain_repository.py` with candidate-state assembly in `services/orchestrator/chain_repository_state.py` | Compatibility facade retained while chain manifest contract/quality helper bodies moved behind `chain_manifests.py` to `chain_manifest_contracts.py`, chain config, source scenario mapping, and orchestration error classes moved to `chain_config.py`, source-cycle repair helpers moved to `chain_source_cycle.py`, runtime helpers moved to `chain_runtime_utils.py`, `AnalysisOrchestrator` moved to `chain_analysis_orchestrator.py`, analysis method bodies moved to `chain_analysis.py`, forecast control methods moved to `chain_forecast_control.py`, forecast cycle normalization/identity helpers moved to `chain_forecast_cycle.py`, forecast trigger/auto-trigger helpers moved to `chain_forecast_trigger.py`, forecast execution/state/submission/template method bodies moved to forecast owner modules, workspace/log helper bodies moved to `chain_workspace.py`, HTTP Slurm client body moved to `chain_slurm_client.py`, and `PsycopgOrchestratorRepository` method bodies moved to repository owner modules under `facade-shrink-scheduler-chain`. | #670, #671, `facade-shrink-scheduler-chain` | Retain legacy chain private names until callers migrate to owner modules or stable public orchestration APIs. New manifest, config/error, source-cycle, runtime, analysis, forecast, workspace/log, HTTP Slurm client, or repository helper exposure must update `docs/governance/CHAIN_COMPATIBILITY_INVENTORY.md` with owner, retention, removal condition, and focused verification. | `wc -l`; `uv run pytest -q tests/test_orchestration_chain.py tests/test_warm_start_chaining.py tests/test_analysis_pipeline.py -k "manifest or assembly or production_status or warm_start"`; `uv run pytest -q tests/test_entropy_audit_script.py -k "compatibility_facade or structural_file_budget or chain"`; `uv run ruff check services/orchestrator/chain_manifests.py services/orchestrator/chain_manifest_contracts.py`; `openspec validate facade-shrink-scheduler-chain --strict --no-interactive`; `git diff --check`. |
| `services/production_closure/two_node_e2e_evidence.py` | 4526 | P1 | `compute_control` production-closure evidence aggregator with display-readonly evidence consumers | Lane-decomposition plan. Keep the aggregator entrypoint stable while Docker security, readonly DB, API/browser, logs, producer identity, source artifact, and manual ops receipt lanes gain explicit contracts. | #672, #674 | Retain the aggregator until #672 defines lane contracts and #674 extracts governed lane implementation behind equivalent result/status/blocker semantics. No path-safety, redaction, current-run, alias, or final aggregation behavior is removed by #668. | Current #668 verification is `wc -l` plus the structural audit row. #672/#674 own lane contract tests, equivalent-fixture checks, and production-closure verification. |
| `services/production_closure/readiness_validation.py` | 1193 | P1 | `compute_control` production-closure readiness aggregator | Lane-decomposition plan. Keep readiness aggregation stable while dependency summary, scheduler evidence, live proof, exclusions, and final readiness ownership is mapped. | #673 | Retain current aggregation until #673 records lane owner modules, result shape, blocker namespaces, and focused verification. Reduction is valid only when final readiness semantics stay equivalent for existing receipts. | Current #668 verification is `wc -l` plus the structural audit row. #673 owns readiness lane inventory and focused validation coverage. |
...
## Governance-8 Inventory Synchronization Evidence

Governance-8 issue #767 confirms that owner-family inventory updates landed in
the same PRs that moved or classified each owner family. This section is an
index of the current inventory authority; it does not introduce a new owner
module, code path, compatibility symbol, lane semantic, or final closeout claim.

| Group | Inventory authority | Covered owner-family evidence | Same-PR inventory proof |
|---|---|---|---|
| Scheduler compatibility facade | `docs/governance/SCHEDULER_COMPATIBILITY_INVENTORY.md` | Tasks 1.1-1.9 map state, lease, discovery, candidate-construction, execution/cohort, evidence-write/proof, and cancellation/status proof surfaces to their owner modules or retained local glue. | Issue #720 / PR #779 records the scheduler group closeout table; the authority file lists governed groups, owners, retention conditions, guard hooks, and verification commands. |
| Chain compatibility facade | `docs/governance/CHAIN_COMPATIBILITY_INVENTORY.md` | Tasks 2.1-2.11 map stage catalog/types, stage execution, array accounting, manifests, reservation, retry, tile publisher, worker/source identity/time consistency, and persistence/repository surfaces. | Issue #731 / PR #790 records the chain group closeout table; the authority file lists governed groups, owners, caller migration paths, guard hooks, and verification commands. |
| Two-node E2E evidence lanes | `docs/governance/TWO_NODE_E2E_EVIDENCE_LANE_INVENTORY.md` | Tasks 3.1-3.13 map shared contracts, metadata, Docker preflight/security, readonly DB, simple-live Slurm/compute/display, API, browser, logs, manual ops, cross-plane/source-scope, and final aggregation lanes. | Issue #744 / PR #803 records the two-node implementation evidence map; the authority file lists lane owner modules, verification selectors, inventory updates, and explicit non-goals. |
| Readiness validation lanes | `docs/governance/READINESS_VALIDATION_LANE_INVENTORY.md` | Tasks 4.1-4.11 map item contracts, shared artifacts, live-proof loading, dependency summaries, scheduler evidence, proof-specific validators, dependency and scheduler live-proof binders, scoped exclusions, and final aggregation lanes. | Issue #755 / PR #814 records the readiness group closeout table; the authority file now scopes Governance-8 issues #745-#755 and lists lane owners, retained facades, verification selectors, and non-targets. |
| API bootstrap facade | This file, `API Bootstrap Group Closeout Evidence` | Tasks 5.1-5.5 map OpenAPI patching, role-aware route registry, startup/static/cache wiring, and retained protected-mutation seam ownership. | Issue #760 / PR #819 records the API task-to-issue-to-PR table, current owner-module line counts, verification commands, and non-targets. |
| Frontend map surface facade | This file, `Frontend Map Surface Closeout Evidence` | Tasks 6.1-6.6 map M11 builders, MapLibre primitives, interaction dispatch, camera/error/status runtime, and popup/selection boundary ownership. | Issue #766 / PR #825 records the frontend task-to-issue-to-PR table, current owner-module line counts, verification commands, and non-targets. |

Issue #767 does not create a deferred final-only inventory batch: every completed
owner family above has a same-PR authority row or closeout map, and future
owner-family movement must update the applicable authority inventory in the
same PR that changes the owner surface.
