...
| `approved-root-path-safety` | Shared/facade owner `services.production_closure.two_node_e2e_evidence`; final-output implementation owner `services.production_closure.two_node_e2e_final_aggregation` | `metadata`, `docker_preflight`, `docker_security`, `readonly_db`, `api`, `browser`, `cross_plane`, `manual_ops`, `slurm`, `logs`, `compute_summary`, `display_summary` | Shared aggregator guards `APPROVED_EVIDENCE_ROOTS`, `_read_json`, `_read_json_bytes`, `_recorded_path_approval_blockers`, `_producer_source_artifact_record_blockers`; retained facade aliases `EvidenceWriter`, `_safe_resolved_evidence_root`, `_path_is_relative_to`, `_refuse_symlink_components`, `_safe_run_id`, `_public_path`; implementation guards `two_node_e2e_final_aggregation.APPROVED_EVIDENCE_ROOTS`, `two_node_e2e_final_aggregation.EvidenceWriter`, `two_node_e2e_final_aggregation._safe_resolved_evidence_root`, `two_node_e2e_final_aggregation._path_is_relative_to`, `two_node_e2e_final_aggregation._refuse_symlink_components`, `two_node_e2e_final_aggregation._safe_run_id`, `two_node_e2e_final_aggregation._public_path` | `TWO_NODE_E2E_EVIDENCE_ROOT_UNAPPROVED`, `TWO_NODE_E2E_EVIDENCE_PATH_UNSAFE`, `TWO_NODE_E2E_RECORDED_PATH_OUTSIDE_APPROVED_ROOTS`, `TWO_NODE_E2E_PRODUCER_SOURCE_ARTIFACT_OUTSIDE_APPROVED_ROOT` | `uv run pytest -q tests/test_two_node_e2e_evidence.py -k "logs or log_uri or redaction or evidence_root or path_safety or stale"` |
| `redaction` | Shared/facade owner `services.production_closure.two_node_e2e_evidence`; final-output implementation owner `services.production_closure.two_node_e2e_final_aggregation` | `metadata`, `docker_preflight`, `docker_security`, `readonly_db`, `api`, `browser`, `cross_plane`, `manual_ops`, `slurm`, `logs`, `compute_summary`, `display_summary` | Shared aggregator guards `LaneEvaluation.to_summary`, `redact_payload`, `redact_text`, `_blocker`, `_finding`; retained facade aliases `EvidenceWriter`, `EvidenceWriter.write_json`; implementation guards `two_node_e2e_final_aggregation.EvidenceWriter`, `two_node_e2e_final_aggregation.EvidenceWriter.write_json` | `TWO_NODE_E2E_EVIDENCE_REDACTION_DEPTH_EXCEEDED`, `TWO_NODE_E2E_EVIDENCE_PAYLOAD_TOO_LARGE` | `uv run pytest -q tests/test_two_node_e2e_evidence.py -k "logs or log_uri or redaction or evidence_root or path_safety or stale"` |
...
| final aggregation | `two_node_e2e_final_aggregation.FINAL_EVIDENCE_SCHEMA`, `two_node_e2e_final_aggregation.FULL_PASS_SOURCE_SET`, `two_node_e2e_final_aggregation.SAFE_RUN_ID_RE`, `two_node_e2e_final_aggregation.EvidenceWriter`, `two_node_e2e_final_aggregation.build_final_summary`, `two_node_e2e_final_aggregation.write_final_summary`, `two_node_e2e_final_aggregation.final_status`, `two_node_e2e_final_aggregation.collect_blockers_and_findings`, `two_node_e2e_final_aggregation.metadata_summary`, `two_node_e2e_final_aggregation._safe_resolved_evidence_root`, `two_node_e2e_final_aggregation._path_is_relative_to`, `two_node_e2e_final_aggregation._safe_run_id`, `two_node_e2e_final_aggregation._public_path`, `validate_two_node_e2e_evidence`, `LaneEvaluation.to_summary`, `_final_status` | New final summary fields, status semantics, redaction behavior, compatibility re-exports, or output safety rules require this inventory to change. |
