...
orchestrator: OBJECT_STORE_PREFIX, SLURM_GATEWAY_URL, WORKSPACE_ROOT
scheduler_db_free: NHMS_SCHEDULER_DB_FREE_REQUIRED, NHMS_SCHEDULER_*_BACKEND=file, registry/readiness/journal/state-index paths
