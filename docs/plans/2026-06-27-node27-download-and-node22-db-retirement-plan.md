...
- node-27 对共享 NFS raw source bundles 运行独立 retention，带 dry-run、
  JSON evidence 和安全路径约束。
...
summary JSON 记录 dry_run/execute、planned/deleted/skipped/failed。
